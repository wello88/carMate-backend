...
userRouter.put('/updateprofile',isAuthenticated(),validateRequest(updateProfileSchema), asyncHandler(UpdateMyProfile))
...
userRouter.post('/rate-winch/:winchId',isAuthenticated(),asyncHandler(RateWinch))
